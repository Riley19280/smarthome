...
#define DEFAULT_RX_TIMEOUT 600                    // Seconds for timeout
...
class asyncHTTPrequest {
  ...
  struct  URL {
    ...
    typedef std::function<void(void*, asyncHTTPrequest*, int readyState, int prevState)> readyStateChangeCB;
    typedef std::function<void(void*, asyncHTTPrequest*, size_t available)> onDataCB;
    typedef std::function<void(void*, asyncHTTPrequest*)> onDisconnectCB;
  ...
  public:
    ...
    void    onDisconnect(onDisconnectCB, void* arg = 0);            // Notify when disconnect happens
...
//___________________________________________________________________________________________________________________________________
  ...
  private:
    ...
    readyStates _readyState; // Request complete, all data available.
    ...
    onDisconnectCB  _onDisconnectCB;            // optional callback when disconnect received
    void*           _onDisconnectCBarg;         // associated user argument
